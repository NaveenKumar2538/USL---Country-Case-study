...
life_expect=st.number_input('Life Expectancy:The average number of years a new born child would live if the current mortality patterns are to remain the same')
...
child_mortality=st.number_input('Child Mortality:Death of children under 5 years of age per 1000 live births')


input_list=[child_mortality,exports,health,imports,income,inflation,life_expect,fert,gdp]
